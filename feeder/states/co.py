...
with psycopg2.connect(database=url.path[1:],
	...
	url = (
			...
			'http://www.aspentimes.com/csp/mediapool/sites/SwiftShared/assets/csp/rssCategoryFeed.csp?pub=AspenTimes&sectionId=745&sectionLabel=News',
			'http://www.aurorasentinel.com/feed/',
			'http://www.boulderweekly.com/news/feed/',
			'http://feeds.broomfieldenterprise.com/mngi/rss/CustomRssServlet/24/218410.xml',
			'http://feeds.lamarledger.com/mngi/rss/CustomRssServlet/27/217303.xml',
			'http://www.canyoncourier.com/todaysnews/rss.xml',
